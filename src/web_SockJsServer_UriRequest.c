...
cx_string _web_SockJsServer_UriRequest_getVar(web_SockJsServer_UriRequest *this, cx_string id) {
...
cx_void _web_SockJsServer_UriRequest_setHeader(web_SockJsServer_UriRequest *this, cx_string name, cx_string val) {
...
cx_void _web_SockJsServer_UriRequest_setStatus(web_SockJsServer_UriRequest *this, cx_uint16 status) {
...
cx_void _web_SockJsServer_UriRequest_write(web_SockJsServer_UriRequest *this, cx_string msg) {
